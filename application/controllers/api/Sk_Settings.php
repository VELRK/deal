...
class Sk_Settings extends Sk_Base_Api {
    ...
    public function index() {
        ...
        $map['wallet_enabled']                 = !empty($walletOffer['enabled']);
        $map['wallet_free_shipping']           = !empty($walletOffer['free_shipping']);
        $map['wallet_discount_percent']        = (float)$walletOffer['discount_percent'];
        $map['wallet_discount_min_rm']         = (float)$walletOffer['discount_min_rm'];
        $map['wallet_discount_promo_text']     = (string)$walletOffer['discount_promo_text'];
        $map['wallet_discount_below_text']     = (string)$walletOffer['discount_below_text'];
        $map['wallet']                         = $walletOffer;
