...
<div class="sk-page-header d-flex flex-wrap align-items-center justify-content-between gap-2">
  ...
  <div class="d-flex gap-2">
    <a href="<?= site_url('shopkart/royalty-report') ?>" class="btn btn-outline-warning btn-sm">Royalty Report</a>
...
<div class="row g-3 mb-4">
  <div class="col-md-3">
    <div class="card p-4 text-center">
      ...
      <div class="display-6 fw-bold text-success"><?= $currency . number_format((float)$wallet['balance'], 2) ?></div>
      <div class="small text-muted mt-1">Cash / top-ups only</div>
    </div>
  </div>
  <div class="col-md-3">
    <div class="card p-4 text-center">
      <div class="text-muted small">Royalty Points</div>
      <div class="display-6 fw-bold text-warning"><?= (int)($royalty_points ?? 0) ?> pts</div>
      <div class="small text-muted mt-1">≈ <?= $currency . number_format((float)($royalty_rm ?? 0), 2) ?></div>
    </div>
  </div>
  <div class="col-md-6">
    <div class="card p-4">
      <h6 class="fw-semibold mb-3">Add Wallet Funds</h6>
      ...
      <p class="small text-muted mt-2 mb-0">Wallet cash and royalty points are separate. Royalty is managed via Royalty Points Report.</p>
    </div>
  </div>
</div>

<div class="card shadow-sm">
  <div class="card-header fw-semibold">Wallet Transaction History</div>
