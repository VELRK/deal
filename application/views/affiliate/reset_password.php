...
<div class="sk-login-wrapper" style="background:linear-gradient(135deg,#065f46,#047857);">
  <div class="sk-login-card card p-4 p-md-5" style="max-width:420px;">
    ...
    <p class="text-muted text-center small mb-3">Choose a new password for your affiliate account.</p>
    ...
    <p class="text-center small mt-4 mb-0">
      <a href="<?= site_url('admin/affiliate/forgot-password') ?>">Request new link</a> ·
