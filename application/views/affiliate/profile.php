        ...
        <form method="post">
          ...
          <div class="row g-2">
            ...
            <div class="col-md-6 mb-3" id="identity">
              ...
              <input type="text" name="mykad_number" class="form-control" placeholder="Enter MyKad number" value="<?= htmlspecialchars($affiliate['mykad_number'] ?? '') ?>" <?= ($affiliate['kyc_status'] ?? '') === 'verified' ? 'readonly' : '' ?>>
            </div>
            <div class="col-md-6 mb-3">
              <label class="form-label">Passport Number</label>
              <input type="text" name="passport_number" class="form-control" placeholder="Enter passport number" value="<?= htmlspecialchars($affiliate['passport_number'] ?? '') ?>" <?= ($affiliate['kyc_status'] ?? '') === 'verified' ? 'readonly' : '' ?>>
            </div>
