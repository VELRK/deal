import{j as e,L as i}from"./index-DekvMh0R.js";import{P as a}from"./PageMeta-B6DR3c0Q.js";function s(){return e.jsx(e.Fragment,{children:e.jsx("section",{className:"section-page-title text-center flat-spacing-2 pb-0",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"main-page-title",children:[e.jsxs("div",{className:"breadcrumbs",children:[e.jsx(i,{to:"/",className:"text-caption-01 cl-text-3 link",children:"Home"}),e.jsx("i",{className:"icon icon-CaretRightThin cl-text-3"}),e.jsx("p",{className:"text-caption-01",children:"About Us"})]}),e.jsx("h3",{children:"About Us"}),e.jsxs("p",{className:"text-body-1 cl-text-2",children:["Coimbatore's destination for elegant ethnic fashion, precision tailoring,",e.jsx("br",{className:"d-none d-lg-block"}),"and timeless handcrafted Aari embroidery."]})]})})})})}function t(){return e.jsxs("section",{className:"about-us-section bg-light-pink-subtle",children:[e.jsx("style",{children:`
        ...
        .about-hero-image-wrap {
          height: 100%;
          min-height: 380px;
          background-image: url('/deal1/frontend/assets/images/about-storefront.png');
