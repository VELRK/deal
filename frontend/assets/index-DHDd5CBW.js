import{m as p,r,o as b,j as e,L as c}from"./index-cBH-Tcoo.js";import{A as f,a as g}from"./AccountSection-CRZrtPYm.js";import{f as m}from"./formatPrice-DUdkiy9u.js";import{P as u}from"./PageMeta-Bq-xRlm_.js";const j=()=>e.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",children:[e.jsx("path",{d:"M21 8l-9-5-9 5 9 5 9-5z"}),e.jsx("path",{d:"M3 8v8l9 5 9-5V8"}),e.jsx("path",{d:"M12 13v8"})]}),v=()=>e.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",children:[e.jsx("circle",{cx:"12",cy:"12",r:"9"}),e.jsx("path",{d:"M12 7v5l3.5 2"})]}),w=()=>e.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",children:[e.jsx("circle",{cx:"12",cy:"12",r:"9"}),e.jsx("path",{d:"M8 12.5l2.5 2.5L16 9.5"})]}),y=()=>e.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",children:[e.jsx("path",{d:"M12 21s-7-6.1-7-11.5A7 7 0 0 1 19 9.5C19 14.9 12 21 12 21z"}),e.jsx("circle",{cx:"12",cy:"9.5",r:"2.25"})]}),k=[{key:"total_orders",label:"Total Orders",Icon:j},{key:"pending",label:"Pending Orders",Icon:v},{key:"delivered",label:"Delivered",Icon:w},{key:"addresses",label:"Saved Addresses",Icon:y}];function N(){p();const[a,n]=r.useState(null),[o,d]=r.useState([]),[l,x]=r.useState(!0);return r.useEffect(()=>{b.dashboard().then(t=>{const s=t.data.data;s&&(n(s.stats),d(s.recent_orders))}).catch(()=>{}).finally(()=>x(!1))},[]),e.jsx(f,{title:"Dashboard",children:e.jsxs("div",{className:"dashboard-classic-wrapper",children:[e.jsx("style",{children:`
        ...
        `}),l?e.jsx("div",{className:"text-center py-5",children:e.jsx("div",{className:"spinner-border text-secondary",role:"status"})}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"classic-stat-grid",children:k.map(({key:t,label:s,Icon:i})=>{const h=t==="total_orders"?a?.total_orders??0:t==="pending"?a?.pending??0:t==="delivered"?a?.delivered??0:a?.addresses??0;return e.jsxs("div",{className:"classic-stat-card",children:[e.jsx("div",{className:"classic-stat-icon",children:e.jsx(i,{})}),e.jsxs("div",{className:"classic-stat-info",children:[e.jsx("div",{className:"stat-label",children:s}),e.jsx("h4",{className:"stat-value",children:h})]})]},t)})}),e.jsxs("div",{className:"tx-history-header",children:[e.jsx("h3",{className:"tx-history-title",children:"Recent Orders"}),e.jsx(c,{to:"/account-orders",className:"classic-btn-view",children:"View All"})]}),e.jsx("div",{className:"tx-table-wrapper",children:o.length===0?e.jsx("div",{className:"classic-empty",children:"No recent orders found."}):e.jsx("div",{className:"table-responsive",children:e.jsxs("table",{className:"tx-table",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Order"}),e.jsx("th",{children:"Date"}),e.jsx("th",{children:"Status"}),e.jsx("th",{children:"Total"}),e.jsx("th",{children:"Actions"})]})}),e.jsx("tbody",{children:o.map(t=>{const s=t.status==="delivered"?"delivered":t.status==="cancelled"?"cancelled":t.status==="shipped"?"shipped":"pending",i=t.status.charAt(0).toUpperCase()+t.status.slice(1);return e.jsxs("tr",{children:[e.jsx("td",{children:e.jsxs("span",{style:{fontWeight:600},children:["#",t.order_number??t.id]})}),e.jsx("td",{children:new Date(t.created_at).toLocaleDateString("en-MY",{day:"numeric",month:"short",year:"numeric"})}),e.jsx("td",{children:e.jsx("span",{className:`tx-status-badge ${s}`,children:i})}),e.jsx("td",{style:{fontWeight:500},children:m(t.total)}),e.jsx("td",{children:e.jsx(c,{to:"/account-orders",className:"classic-btn-view",style:{fontSize:"11px",borderBottom:"none",padding:0},children:"View"})})]},t.id)})})]})})})]})]})})}const M=()=>e.jsxs(e.Fragment,{children:[e.jsx(u,{title:"My Account | 2Deal - Online Saree & Ethnic Wear Store",description:"2Deal - Online Saree & Ethnic Wear Store"}),e.jsx(g,{}),e.jsx(N,{})]});export{M as default};
