import{j as e,L as n,E as p,a as x,f as c,C as f,p as g}from"./index-B06glYH_.js";import{s as u}from"./shop-Bjd2sSqa.js";import{P as w}from"./PageMeta-CtYyA6X7.js";import"./shop-product-Di73uMqE.js";function j(){return e.jsx(e.Fragment,{children:e.jsx("section",{className:"section-page-title text-center flat-spacing-2 pb-0",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"main-page-title",children:[e.jsxs("div",{className:"breadcrumbs",children:[e.jsx(n,{to:"/",className:"text-caption-01 cl-text-3 link",children:"Home"}),e.jsx("i",{className:"icon icon-CaretRightThin cl-text-3"}),e.jsx("p",{className:"text-caption-01",children:"Your Wishlist"})]}),e.jsx("h3",{children:"Your Wishlist"}),e.jsxs("p",{className:"text-body-1 cl-text-2",children:["Explore your saved favorites, manage your wishlist effortlessly,",e.jsx("br",{className:"d-none d-lg-block"}),"and keep track of the items you love most."]})]})})})})}function b({product:s,removeFromWishlist:l}){const r=s.img||"/frontend/assets/images/product/product-1.jpg",o=x(r),t=s.unitVariants??[],i=t.length>0?t.every(a=>Number(a.stock??0)<=0):!!s.isStockOut||Number(s.stock??0)<=0;return e.jsxs("div",{className:"classic-wishlist-item",children:[e.jsx("div",{className:"wishlist-item-image",children:e.jsx(n,{to:`/product-detail/${s.id}`,children:e.jsx("img",{loading:"lazy",src:o,alt:s.name})})}),e.jsxs("div",{className:"wishlist-item-details",children:[e.jsx(n,{to:`/product-detail/${s.id}`,className:"wishlist-item-name",children:s.name}),e.jsxs("div",{className:"wishlist-item-price",children:[e.jsx("span",{className:"current-price",children:c(s.price)}),s.priceOld&&e.jsx("span",{className:"old-price",children:c(s.priceOld)})]}),e.jsxs("div",{className:"wishlist-item-stock",children:[e.jsx("span",{className:"status-dot",style:i?{background:"#dc2626"}:void 0}),i?"Out of Stock":"In Stock"]})]}),e.jsxs("div",{className:"wishlist-item-actions",children:[e.jsx("button",{type:"button",className:"classic-btn-primary",disabled:i,onClick:a=>{if(a.preventDefault(),i)return;const{setQuickAddItem:m,setQuickAddProduct:h}=f.getState();m(s.id),h(s),g.getState().openModal("quickAdd")},children:i?"OUT OF STOCK":"ADD TO CART"}),e.jsxs("button",{type:"button",className:"classic-btn-remove",onClick:()=>l(s.id),children:[e.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[e.jsx("path",{d:"M18 6L6 18"}),e.jsx("path",{d:"M6 6l12 12"})]}),"REMOVE"]})]})]})}function y(){const{items:s,toggle:l,loading:r}=p(),o=t=>{const i=s.find(a=>a.id===t);i&&l(i)};return e.jsxs("div",{className:"section-wishlist flat-spacing-2",children:[e.jsx("style",{children:`
