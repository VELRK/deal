import{j as e,L as y,B as q,n as G,r as n,s as J,p as U,q as X,v as A,f as c,C as Z,y as ee,a as te}from"./index-cH8S10ur.js";import{a as ae,s as M,b as C,M as oe}from"./MayBe-BXNs2vm1.js";import{s as re}from"./shop-B1efHd22.js";import{P as se}from"./PageMeta-DBBnt-zX.js";import"./ProductCard-BbDGfkce.js";import"./WishlistButton-DfcLy6fx.js";import"./productViewStore-Cx6JWfhQ.js";import"./TfSwiper-Zm04U9NW.js";import"./shop-product-DrBjegB4.js";function ne(){return e.jsx("section",{className:"section-page-title text-center flat-spacing-2 pb-0",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"main-page-title",children:[e.jsxs("div",{className:"breadcrumbs",children:[e.jsx(y,{to:"/",className:"text-caption-01 cl-text-3 link",children:"Home"}),e.jsx("i",{className:"icon icon-CaretRightThin cl-text-3"}),e.jsx("p",{className:"text-caption-01",children:"Shopping Cart"})]}),e.jsx("h3",{children:"Shopping Cart"})]})})})}function ce(){const i=q(t=>t.cartProducts),r=q(t=>t.updateQuantity),s=q(t=>t.totalPrice),{isLoggedIn:d}=G(),[v,w]=n.useState(""),[f,h]=n.useState(""),[j,g]=n.useState(0),[E,m]=n.useState(""),[z,k]=n.useState(!1),[p,P]=n.useState(null),[u,R]=n.useState(!1),[B,W]=n.useState(50),[_,Y]=n.useState(999);n.useMemo(()=>{J.get().then(t=>{if(t.data.success&&t.data.data){const o=t.data.data;typeof o.shipping_charge=="number"&&W(o.shipping_charge),typeof o.free_shipping_above=="number"&&Y(o.free_shipping_above)}}).catch(t=>console.error("Failed to load settings",t))},[]),n.useEffect(()=>{if(!d||s<=0)return;const t=ae();if(t){h(t.code),g(t.discount);return}const o=sessionStorage.getItem("sk_affiliate_ref");if(!o)return;let a=!1;return k(!0),U.apply({code:o,order_amount:s}).then(x=>{if(a)return;const l=x.data;l.success&&l.data?(h(l.data.code),g(l.data.discount),M({code:l.data.code,discount:l.data.discount})):m(l.message??"Invalid affiliate promo code.")}).catch(x=>{if(a)return;const l=x?.response?.data?.message;m(l??"Could not apply affiliate promo code.")}).finally(()=>{a||k(!1)}),()=>{a=!0}},[d,s]),n.useEffect(()=>{if(!d){P(null);return}let t=!1;const o=a=>{t||(P(a),a&&!a.can_redeem&&u&&(R(!1),C(!1)))};return X.getRoyalty().then(a=>{const x=a.data?.data??null;if(x){o(x);return}return A.get().then(l=>{o(l.data?.data?.summary?.royalty??null)})}).catch(()=>{A.get().then(a=>o(a.data?.data?.summary?.royalty??null)).catch(()=>{t||P(null)})}),()=>{t=!0}},[d,i.length,s]);const L=t=>{R(t),C(t)};n.useEffect(()=>{i.length===0&&u&&(R(!1),C(!1))},[i.length,u]);const $=async()=>{const t=v.trim().toUpperCase();if(t){if(!d){m("Please login to apply a promo code.");return}k(!0),m("");try{const a=(await U.apply({code:t,order_amount:s})).data;a.success&&a.data?(h(a.data.code),g(a.data.discount),w(""),M({code:a.data.code,discount:a.data.discount})):m(a.message??"Invalid promo code.")}catch(o){const a=o?.response?.data?.message;m(a??"Invalid or expired promo code.")}finally{k(!1)}}},O=()=>{h(""),g(0),m(""),M(null)},I=j,N=s<=0||s>=_?0:B,S=Math.max(0,s-I)+N,D=!!p&&p.enabled!==!1&&(!!p.show_on_cart||!!p.can_redeem||Number(p.points)>0),T=D&&S>0,b=u&&T?Math.min(Number(p?.balance_rm||0),S):0,F=Math.max(0,S-b),H=Math.max(0,_-s),V=(t,o,a)=>{ee(t,o,a)},K=(t,o,a,x)=>{if(o<1){V(t,a,x);return}r(t,o,a),A.update({product_id:Number(t),quantity:o,...a!=null?{variant_id:a}:{}}).catch(()=>{})};return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
