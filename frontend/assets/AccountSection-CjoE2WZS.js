import{S as e,T as t,s as n,w as r,x as i}from"./index-hjKFKyKu.js";function a(e){return null}var o=[{href:`/account-page`,label:`Dashboard`,icon:`icon-HouseLine`},{href:`/account-orders`,label:`My Orders`,icon:`icon-Package`},{href:`/account-addresses`,label:`My Addresses`,icon:`icon-storefront`},{href:`/account-setting`,label:`Settings`,icon:`icon-GearSix`},{href:`/account-wallet`,label:`My Wallet`,icon:`icon-Wallet`}],s=n();function c(){let{pathname:n}=r(),a=t(),{logout:c}=i();function l(){c(),a(`/`)}return(0,s.jsxs)(`div`,{className:`sidebar-account-custom`,children:[(0,s.jsx)(`style`,{children:`
