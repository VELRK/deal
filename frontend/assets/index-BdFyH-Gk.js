import{o as b,r as d,v as u,x as m,j as t,L as x,f as v}from"./index-fZV34PZE.js";import{A as j,a as w}from"./AccountSection-CQNfQrFg.js";import{P as y}from"./PageMeta-52rcAE-I.js";const k=()=>t.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",children:[t.jsx("path",{d:"M21 8l-9-5-9 5 9 5 9-5z"}),t.jsx("path",{d:"M3 8v8l9 5 9-5V8"}),t.jsx("path",{d:"M12 13v8"})]}),N=()=>t.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",children:[t.jsx("circle",{cx:"12",cy:"12",r:"9"}),t.jsx("path",{d:"M12 7v5l3.5 2"})]}),A=()=>t.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",children:[t.jsx("circle",{cx:"12",cy:"12",r:"9"}),t.jsx("path",{d:"M8 12.5l2.5 2.5L16 9.5"})]}),S=()=>t.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",children:[t.jsx("path",{d:"M12 21s-7-6.1-7-11.5A7 7 0 0 1 19 9.5C19 14.9 12 21 12 21z"}),t.jsx("circle",{cx:"12",cy:"9.5",r:"2.25"})]}),z=[{key:"total_orders",label:"Successful Orders",Icon:k},{key:"pending",label:"Pending Orders",Icon:N},{key:"delivered",label:"Delivered",Icon:A},{key:"addresses",label:"Saved Addresses",Icon:S}];function C(){b();const[n,p]=d.useState(null),[l,h]=d.useState([]),[f,g]=d.useState(!0);return d.useEffect(()=>{Promise.all([u.dashboard().catch(()=>null),m.getAll().catch(()=>null)]).then(([e,a])=>{if(!e)return;const r=e.data.data;if(r){const i={...r.stats};if(a&&a.data){const o=a.data.data||[];i.total_orders=o.filter(s=>{const c=s.status?.toLowerCase();return!["payment_attempt","abandoned","cancelled","returned","failed"].includes(c||"")}).length,i.pending=o.filter(s=>{const c=s.status?.toLowerCase();return["pending","confirmed","processing","shipped"].includes(c||"")}).length,i.delivered=o.filter(s=>s.status?.toLowerCase()==="delivered").length}p(i),h(r.recent_orders.filter(o=>{const s=o.status?.toLowerCase();return s!=="payment_attempt"&&s!=="abandoned"}))}}).finally(()=>g(!1))},[]),t.jsx(j,{title:"Dashboard",children:t.jsxs("div",{className:"dashboard-classic-wrapper",children:[t.jsx("style",{children:`
