import{l as m,r as a,m as x,j as e}from"./index-CgPjw6Am.js";import{S as g}from"./Shop-DN3TLqVZ.js";import{P as b}from"./PageMeta-CdGIolSg.js";import"./ShopListingUi-CCGd0yl8.js";import"./index-euSdUcCZ.js";import"./ProductCard-BCR04Cxp.js";import"./WishlistButton-AgTUKDsh.js";import"./productViewStore-Ck5eph-w.js";function N(){const[c]=m(),o=c.get("category_slug")??"",[t,i]=a.useState(null);a.useEffect(()=>{if(!o){i(null);return}x.getAll().then(d=>{const p=d.data.data??[];let r=null;const s=h=>{for(const n of h){if(n.slug===o){r=n;return}if(n.children&&s(n.children),r)return}};s(p),i(r)}).catch(()=>i(null))},[o]);const l=t?.name??"Incense Cone Collection";return e.jsxs(e.Fragment,{children:[e.jsx(b,{title:`${l} | 2Deal`,description:"Discover our sacred collection."}),e.jsx("style",{children:`
