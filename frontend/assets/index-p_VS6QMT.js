...
} const v = () => e.jsxs(e.Fragment, { children: [e.jsx(h, { title: "Orders FAQs | 2Deal", description: "Find answers to frequently asked questions about 2Deal orders, custom tailoring measurements, Aari embroidery timetables, bulk orders, and return policies." }), e.jsx(m, {}), e.jsx(b, {})] }); export { v as default };
