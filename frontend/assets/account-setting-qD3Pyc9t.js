import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./react-CZI7_Jkm.js";import{h as n}from"./api-CK69NYk9.js";import{s as r,x as i}from"./index-PDFvZlAW.js";import{a,i as o,n as s,o as c,t as l}from"./malaysiaPhone-Bpv5FhOl.js";import{n as u,t as d}from"./AccountSection-tXfbZfZJ.js";import{t as f}from"./PageMeta-CyS8ELM3.js";var p=e(t(),1),m=r();function h(){let{user:e,setUser:t}=i(),[r,u]=(0,p.useState)(e?.name??``),[f,h]=(0,p.useState)(()=>{let t=e?.phone??``;if(!t)return``;let n=a(t);return n.startsWith(`60`)?`0`+n.slice(2):n}),g=e?.email??``,_=g.startsWith(`ph_`)||g.includes(`@Indian Ladies Fashion.app`),[v,y]=(0,p.useState)(_?``:g),[b,x]=(0,p.useState)(!1),[S,C]=(0,p.useState)(null);async function w(e){if(e.preventDefault(),!r.trim())return C({type:`error`,text:`Full name is required.`});if(f.trim()&&!o(f))return C({type:`error`,text:l});C(null),x(!0);try{let e={name:r.trim(),phone:f.trim()?c(f):``};_&&v.trim()&&(e.email=v.trim());let i=(await n.updateProfile(e)).data.data;i&&t(i),C({type:`success`,text:`Profile updated successfully.`})}catch(e){let t=e?.response?.data?.message;C({type:`error`,text:t??`Failed to save changes. Please try again.`})}finally{x(!1)}}return(0,m.jsx)(d,{title:`Account Details`,children:(0,m.jsxs)(`div`,{className:`settings-container-custom`,children:[(0,m.jsx)(`style`,{children:`
