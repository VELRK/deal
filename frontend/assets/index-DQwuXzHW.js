import{m,r as a,n as x,j as e}from"./index-D4yqL2eJ.js";import{S as g}from"./Shop-DoAr5QXT.js";import{P as b}from"./PageMeta-C0Bx0o8T.js";import"./ShopListingUi-D9514nJJ.js";import"./index-Q2zkwIIv.js";import"./ProductCard-CowEAvRZ.js";import"./WishlistButton-B55GwqtA.js";import"./productViewStore-0ZSm9ov1.js";function N(){const[c]=m(),o=c.get("category_slug")??"",[t,i]=a.useState(null);a.useEffect(()=>{if(!o){i(null);return}x.getAll().then(d=>{const p=d.data.data??[];let r=null;const s=h=>{for(const n of h){if(n.slug===o){r=n;return}if(n.children&&s(n.children),r)return}};s(p),i(r)}).catch(()=>i(null))},[o]);const l=t?.name??"Incense Cone Collection";return e.jsxs(e.Fragment,{children:[e.jsx(b,{title:`${l} | 2Deal`,description:"Discover our sacred collection."}),e.jsx("style",{children:`
