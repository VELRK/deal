import { r as e } from "./chunk-DECur_0Z.js"; import { t } from "./react-DhTzgwgF.js"; import { n } from "./chunk-QFMPRPBF-BNQPla1W.js"; import { t as r } from "./authStore-cePwo9pG.js"; import { h as i } from "./api-CLcNGb5M.js"; import { t as a } from "./jsx-runtime-DdEXjPBp.js"; import { t as o } from "./formatPrice-BTsvo7Cc.js"; import { n as s, t as c } from "./AccountSection-CIbDtcCp.js"; import { t as l } from "./PageMeta-6gZ1jYam.js"; var u = e(t(), 1), d = a(), f = [{ key: `total_orders`, label: `Total Orders`, icon: `📦`, bg: `#fdfafb`, text: `#3ec1bc`, border: `rgba(193, 16, 105, 0.12)` }, { key: `pending`, label: `Pending Orders`, icon: `⏳`, bg: `#fffbeb`, text: `#b45309`, border: `#fef3c7` }, { key: `delivered`, label: `Delivered`, icon: `✅`, bg: `#f0fdf4`, text: `#15803d`, border: `#dcfce7` }, { key: `addresses`, label: `Saved Addresses`, icon: `📍`, bg: `#faf5ff`, text: `#6b21a8`, border: `#f3e8ff` }]; function p() {
  r(); let [e, t] = (0, u.useState)(null), [a, s] = (0, u.useState)([]), [l, p] = (0, u.useState)(!0); return (0, u.useEffect)(() => { i.dashboard().then(e => { let n = e.data.data; n && (t(n.stats), s(n.recent_orders)) }).catch(() => { }).finally(() => p(!1)) }, []), (0, d.jsx)(c, {
    title: `Dashboard`, children: (0, d.jsxs)(`div`, {
      className: `dashboard-container-custom`, children: [(0, d.jsx)(`style`, {
        children: `
