import{r as s,v as m,j as e,f as l,X as w}from"./index-T0UyoNnL.js";import{A as N,a as v}from"./AccountSection-DXOOyDA0.js";import{P as _}from"./PageMeta-CgUDEhSj.js";function k(){const[a,y]=s.useState(null),[d,h]=s.useState([]),[f,b]=s.useState(0),[u,g]=s.useState(!0),[j,c]=s.useState(!0),[o,p]=s.useState(1),r=10;s.useEffect(()=>{m.getRoyalty().then(t=>{t.data?.success&&y(t.data.data)}).catch(console.error).finally(()=>g(!1))},[]),s.useEffect(()=>{c(!0);const t=(o-1)*r;m.getRoyaltyTransactions({limit:r,offset:t}).then(x=>{if(x.data?.success){const i=x.data.data;h(i.rows??i.transactions??[]),b(i.total??0)}}).catch(console.error).finally(()=>c(!1))},[o]);const n=Math.ceil(f/r);return e.jsx(N,{title:"Royalty Points",children:e.jsxs("div",{className:"royalty-page",children:[e.jsx("style",{children:`
