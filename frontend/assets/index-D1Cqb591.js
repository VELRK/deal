import{k as x,r as s,l as g,a as f,j as t}from"./index-9tzjSN1n.js";import{S as b}from"./Shop-sAAdrWJp.js";import{P as u}from"./PageMeta-IC4-gMZV.js";import"./ShopListingUi-C0R1Pd0I.js";import"./index-Biph07Ce.js";import"./ProductCard-DEJONhc8.js";import"./WishlistButton-DKAF29O1.js";import"./productViewStore-4rcO9nNT.js";function N(){const[p]=x(),e=p.get("category_slug")??"",[o,r]=s.useState(null);s.useEffect(()=>{if(!e){r(null);return}g.getAll().then(l=>{const m=l.data.data??[];let i=null;const a=h=>{for(const n of h){if(n.slug===e){i=n;return}if(n.children&&a(n.children),i)return}};a(m),r(i)}).catch(()=>r(null))},[e]);const c=o?.name??"Incense Cone Collection",d=o?.image_url?o.image_url:o?.image?f(o.image):"https://plain-apac-prod-public.komododecks.com/202607/04/kRRb75cQ5wV0IBnHrw04/image.png";return t.jsxs(t.Fragment,{children:[t.jsx(u,{title:`${c} | 2Deal`,description:"Discover our sacred collection."}),t.jsx("style",{children:`
