import { r as a, p as x, j as e, f as h } from "./index-DekvMh0R.js"; import { A as N, a as v } from "./AccountSection-C628uyFH.js"; import { P } from "./PageMeta-B6DR3c0Q.js"; function R() {
  const [s, f] = a.useState(null), [l, y] = a.useState([]), [m, b] = a.useState(0), [g, u] = a.useState(!0), [j, d] = a.useState(!0), [o, c] = a.useState(1), r = 10; a.useEffect(() => { x.getRoyalty().then(t => { t.data?.success && f(t.data.data) }).catch(console.error).finally(() => u(!1)) }, []), a.useEffect(() => { d(!0); const t = (o - 1) * r; x.getRoyaltyTransactions({ limit: r, offset: t }).then(p => { if (p.data?.success) { const i = p.data.data; y(i.rows ?? i.transactions ?? []), b(i.total ?? 0) } }).catch(console.error).finally(() => d(!1)) }, [o]); const n = Math.ceil(m / r); function w(t) { try { return new Date(t).toLocaleDateString("en-MY", { year: "numeric", month: "short", day: "numeric", hour: "2-digit", minute: "2-digit" }) } catch { return t } } return e.jsx(N, {
