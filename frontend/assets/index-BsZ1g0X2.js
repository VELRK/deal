import{r as s,v as x,j as e,f as y,S as w}from"./index-CX2cT7nw.js";import{A as N,a as v}from"./AccountSection-Bdw6gS7X.js";import{P}from"./PageMeta-Bm7iPlgg.js";function R(){const[a,f]=s.useState(null),[l,h]=s.useState([]),[m,b]=s.useState(0),[g,u]=s.useState(!0),[j,d]=s.useState(!0),[o,c]=s.useState(1),r=10;s.useEffect(()=>{x.getRoyalty().then(t=>{t.data?.success&&f(t.data.data)}).catch(console.error).finally(()=>u(!1))},[]),s.useEffect(()=>{d(!0);const t=(o-1)*r;x.getRoyaltyTransactions({limit:r,offset:t}).then(p=>{if(p.data?.success){const i=p.data.data;h(i.rows??i.transactions??[]),b(i.total??0)}}).catch(console.error).finally(()=>d(!1))},[o]);const n=Math.ceil(m/r);return e.jsx(N,{title:"Royalty Points",children:e.jsxs("div",{className:"royalty-page",children:[e.jsx("style",{children:`
