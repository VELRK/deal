...
import { r as e } from "./chunk-DECur_0Z.js"; import { t } from "./react-DhTzgwgF.js"; import { t as n } from "./authStore-cePwo9pG.js"; import { h as r } from "./api-CLcNGb5M.js"; import { t as i } from "./jsx-runtime-DdEXjPBp.js"; import { n as a, t as o } from "./AccountSection-CIbDtcCp.js"; import { t as s } from "./PageMeta-6gZ1jYam.js"; var c = e(t(), 1), l = i(); function u() {
  let { user: e, setUser: t } = n(), [i, a] = (0, c.useState)(e?.name ?? ``), [s, u] = (0, c.useState)(e?.phone ?? ``), d = e?.email ?? ``, f = d.startsWith(`ph_`) || d.includes(`@2Deal.app`), [p, m] = (0, c.useState)(f ? `` : d), [h, g] = (0, c.useState)(!1), [_, v] = (0, c.useState)(null); async function y(e) { if (e.preventDefault(), !i.trim()) return v({ type: `error`, text: `Full name is required.` }); v(null), g(!0); try { let e = { name: i.trim(), phone: s.trim() }; f && p.trim() && (e.email = p.trim()); let n = (await r.updateProfile(e)).data.data; n && t(n), v({ type: `success`, text: `Profile updated successfully.` }) } catch (e) { let t = e?.response?.data?.message; v({ type: `error`, text: t ?? `Failed to save changes. Please try again.` }) } finally { g(!1) } } return (0, l.jsx)(o, {
...
>>>>>>> 47b9b0a (added catgories bold):frontend/assets/account-setting-qfPPcjFd.js
