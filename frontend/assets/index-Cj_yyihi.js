import{m,r as a,n as x,j as e}from"./index-D3XEbDAg.js";import{S as g}from"./Shop-BRdqMrvH.js";import{P as b}from"./PageMeta-CChtQV5h.js";import"./ShopListingUi-hgmWVJwW.js";import"./index-BC5vKXOg.js";import"./ProductCard-CclHl_bz.js";import"./WishlistButton-Bfme5vtl.js";import"./productViewStore-DCzDzh8l.js";function N(){const[c]=m(),o=c.get("category_slug")??"",[t,i]=a.useState(null);a.useEffect(()=>{if(!o){i(null);return}x.getAll().then(d=>{const p=d.data.data??[];let r=null;const s=h=>{for(const n of h){if(n.slug===o){r=n;return}if(n.children&&s(n.children),r)return}};s(p),i(r)}).catch(()=>i(null))},[o]);const l=t?.name??"Incense Cone Collection";return e.jsxs(e.Fragment,{children:[e.jsx(b,{title:`${l} | 2Deal`,description:"Discover our sacred collection."}),e.jsx("style",{children:`
