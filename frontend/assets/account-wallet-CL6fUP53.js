import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./react-CZI7_Jkm.js";import{h as n}from"./api-CK69NYk9.js";import{D as r,S as i,s as a,t as o}from"./index-PDFvZlAW.js";import{n as s,t as c}from"./AccountSection-tXfbZfZJ.js";import{t as l}from"./PageMeta-CyS8ELM3.js";var u=e(t(),1),d=a();function f(){let[e,t]=r(),[a,s]=(0,u.useState)(null),[l,f]=(0,u.useState)(null),[p,m]=(0,u.useState)([]),[h,g]=(0,u.useState)(0),[_,v]=(0,u.useState)(!0),[y,b]=(0,u.useState)(!0),[x,S]=(0,u.useState)(1);(0,u.useEffect)(()=>{let r=e.get(`topup`);if(r===`success`){s({type:`success`,text:`Wallet topped up successfully!`}),window.dispatchEvent(new CustomEvent(`sk-wallet-updated`))}else if(r===`failed`){s({type:`error`,text:`Payment was not completed. No amount was added.`})}if(r===`success`||r===`failed`){let r=new URLSearchParams(e);r.delete(`topup`),t(r,{replace:!0})}},[e,t]),(0,u.useEffect)(()=>{let r=()=>{n.getWallet().then(e=>{e.data?.success&&f(e.data.data)}).catch(console.error).finally(()=>v(!1))};r();let i=()=>{r(),S(1),b(!0),n.getWalletTransactions({limit:10,offset:0}).then(e=>{if(e.data?.success){let t=e.data.data;m(t.rows??t.transactions??[]),g(t.total??0)}}).catch(console.error).finally(()=>b(!1))};return window.addEventListener(`sk-wallet-updated`,i),()=>window.removeEventListener(`sk-wallet-updated`,i)},[]),(0,u.useEffect)(()=>{b(!0);let e=(x-1)*10;n.getWalletTransactions({limit:10,offset:e}).then(e=>{if(e.data?.success){let t=e.data.data;m(t.rows??t.transactions??[]),g(t.total??0)}}).catch(console.error).finally(()=>b(!1))},[x]);let C=Math.ceil(h/10);function w(e){try{return new Date(e).toLocaleDateString(`en-MY`,{year:`numeric`,month:`short`,day:`numeric`,hour:`2-digit`,minute:`2-digit`})}catch{return e}}function T(e){switch(e){case`admin_add`:return`Admin Credit`;case`order_payment`:return`Order Payment`;case`refund`:return`Order Refund`;case`promo`:return`Promo Bonus`;case`topup`:case`topup_sandbox`:return`Wallet Top-Up`;case`adjustment`:return`Wallet Adjustment`;default:return e}}return(0,d.jsx)(c,{title:`My Wallet`,children:(0,d.jsxs)(`div`,{className:`wallet-container-custom`,children:[(0,d.jsx)(`style`,{children:`
