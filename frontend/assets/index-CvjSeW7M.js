import{l as m,r as a,m as x,j as e}from"./index-BDJLzn2W.js";import{S as g}from"./Shop-NWcyBulU.js";import{P as b}from"./PageMeta-BtNEW1Y7.js";import"./ShopListingUi-C0DWobj6.js";import"./index-Dm4fq8I0.js";import"./ProductCard-CSgBq0N9.js";import"./WishlistButton-Duciraba.js";import"./productViewStore--xk_cthY.js";function N(){const[c]=m(),o=c.get("category_slug")??"",[t,i]=a.useState(null);a.useEffect(()=>{if(!o){i(null);return}x.getAll().then(d=>{const p=d.data.data??[];let r=null;const s=h=>{for(const n of h){if(n.slug===o){r=n;return}if(n.children&&s(n.children),r)return}};s(p),i(r)}).catch(()=>i(null))},[o]);const l=t?.name??"Incense Cone Collection";return e.jsxs(e.Fragment,{children:[e.jsx(b,{title:`${l} | 2Deal`,description:"Discover our sacred collection."}),e.jsx("style",{children:`
