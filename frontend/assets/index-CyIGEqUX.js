import{i as x,r as p,k as g,a as f,j as t}from"./index-Bx-aQa3S.js";import{S as b}from"./Shop-CWSAuLRm.js";import{P as u}from"./PageMeta-CMERlfd_.js";import"./ShopListingUi-CAH-yDyP.js";import"./index-DrAr3wZO.js";import"./ProductCard-BmvkLiZP.js";import"./formatPrice-DUdkiy9u.js";import"./WishlistButton-CClneEZy.js";import"./productViewStore-DYjcUyNN.js";function S(){const[s]=x(),r=s.get("category_slug")??"",[o,e]=p.useState(null);p.useEffect(()=>{if(!r){e(null);return}g.getAll().then(l=>{const m=l.data.data??[];let i=null;const a=h=>{for(const n of h){if(n.slug===r){i=n;return}if(n.children&&a(n.children),i)return}};a(m),e(i)}).catch(()=>e(null))},[r]);const c=o?.name??"Incense Cone Collection",d=o?.image_url?o.image_url:o?.image?f(o.image):"https://plain-apac-prod-public.komododecks.com/202607/04/kRRb75cQ5wV0IBnHrw04/image.png";return t.jsxs(t.Fragment,{children:[t.jsx(u,{title:`${c} | 2Deal`,description:"Discover our sacred collection."}),t.jsx("style",{children:`
