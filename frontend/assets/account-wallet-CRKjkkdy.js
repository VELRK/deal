import { r as e } from "./rolldown-runtime-QTnfLwEv.js"; import { t } from "./react-CZI7_Jkm.js"; import { h as n } from "./api-BFkhFdfc.js"; import { C as r, c as i, t as a } from "./index-C1-Yj25L.js"; import { n as o, t as s } from "./AccountSection-BKQUisF4.js"; import { t as c } from "./PageMeta-CyS8ELM3.js"; var l = e(t(), 1), u = i(); function d() {
  let [e, t] = (0, l.useState)(null), [i, o] = (0, l.useState)([]), [c, d] = (0, l.useState)(0), [f, p] = (0, l.useState)(!0), [m, h] = (0, l.useState)(!0), [g, _] = (0, l.useState)(1); (0, l.useEffect)(() => { n.getWallet().then(e => { e.data?.success && t(e.data.data) }).catch(console.error).finally(() => p(!1)) }, []), (0, l.useEffect)(() => { h(!0); let e = (g - 1) * 10; n.getWalletTransactions({ limit: 10, offset: e }).then(e => { e.data?.success && (o(e.data.data.rows), d(e.data.data.total)) }).catch(console.error).finally(() => h(!1)) }, [g]); let v = Math.ceil(c / 10); function y(e) { try { return new Date(e).toLocaleDateString(`en-MY`, { year: `numeric`, month: `short`, day: `numeric`, hour: `2-digit`, minute: `2-digit` }) } catch { return e } } function b(e) { switch (e) { case `admin_add`: return `Admin Credit`; case `order_payment`: return `Order Payment`; case `refund`: return `Order Refund`; case `promo`: return `Promo Bonus`; case `adjustment`: return `Wallet Adjustment`; default: return e } } return (0, u.jsx)(s, {
    title: `My Wallet`, children: (0, u.jsxs)(`div`, {
      className: `wallet-container-custom`, children: [(0, u.jsx)(`style`, {
        children: `
