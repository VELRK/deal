import { j as e, L as y, r as a, V as N } from "./index-DoE3uCvc.js"; import { P as w } from "./PageMeta-D_VAME4y.js"; function k() { return e.jsx(e.Fragment, { children: e.jsx("section", { className: "section-page-title text-center flat-spacing-2 pb-0", children: e.jsx("div", { className: "container", children: e.jsxs("div", { className: "main-page-title", children: [e.jsxs("div", { className: "breadcrumbs", children: [e.jsx(y, { to: "/", className: "text-caption-01 cl-text-3 link", children: "Home" }), e.jsx("i", { className: "icon icon-CaretRightThin cl-text-3" }), e.jsx("p", { className: "text-caption-01", children: "Contact Us" })] }), e.jsx("h3", { children: "Contact Us" }), e.jsx("p", { className: "text-body-1 cl-text-2", children: "Get in touch with us for inquiries, support, or collaboration we’re here to help you." })] }) }) }) }) } function S() { return e.jsx(e.Fragment, { children: e.jsx("div", { className: "section-map flat-spacing-2 pb-0", children: e.jsx("div", { className: "container", children: e.jsx("div", { className: "wg-map", children: e.jsx("iframe", { src: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7880.148272329334!2d151.20657421407668!3d-33.858885268389294!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6b12ae682c546039%3A0x16da940d587922a1!2sCircular%20Quay!5e0!3m2!1sen!2s!4v1745205798630!5m2!1sen!2s", allowFullScreen: !0, loading: "lazy", referrerPolicy: "no-referrer-when-downgrade" }) }) }) }) }) } function F() {
  const [n, l] = a.useState(""), [d, x] = a.useState(""), [o, m] = a.useState(""), [i, p] = a.useState(""), [h, f] = a.useState(!1), [g, u] = a.useState(!1), [b, j] = a.useState(!1), [s, c] = a.useState(null); async function v() { if (!n.trim() || !o.trim() || !i.trim()) { c({ type: "error", text: "Please fill in all required fields." }); return } if (!h || !g) { c({ type: "error", text: "Please accept both consent checkboxes." }); return } j(!0), c(null); try { const t = `${n.trim()} ${d.trim()}`.trim(), r = await N.send({ name: t, email: o.trim(), message: i.trim() }); c({ type: "success", text: r.data.message ?? "Message sent! We'll get back to you soon." }), l(""), x(""), m(""), p(""), f(!1), u(!1) } catch (t) { const r = t?.response?.data?.message; c({ type: "error", text: r ?? "Failed to send message. Please try again." }) } finally { j(!1) } } return e.jsxs(e.Fragment, {
