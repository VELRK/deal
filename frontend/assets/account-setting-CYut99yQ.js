import { r as e } from "./rolldown-runtime-QTnfLwEv.js"; import { t } from "./react-CZI7_Jkm.js"; import { h as n } from "./api-DfkJ5d7t.js"; import { S as r, c as i } from "./index-CKqq9D3X.js"; import { n as a, t as o } from "./AccountSection-sDnMMCEz.js"; import { t as s } from "./PageMeta-CyS8ELM3.js"; var c = e(t(), 1), l = i(); function u() {
  let { user: e, setUser: t } = r(), [i, a] = (0, c.useState)(e?.name ?? ``), [s, u] = (0, c.useState)(e?.phone ?? ``), d = e?.email ?? ``, f = d.startsWith(`ph_`) || d.includes(`@2Deal.app`), [p, m] = (0, c.useState)(f ? `` : d), [h, g] = (0, c.useState)(!1), [_, v] = (0, c.useState)(null); async function y(e) { if (e.preventDefault(), !i.trim()) return v({ type: `error`, text: `Full name is required.` }); v(null), g(!0); try { let e = { name: i.trim(), phone: s.trim() }; f && p.trim() && (e.email = p.trim()); let r = (await n.updateProfile(e)).data.data; r && t(r), v({ type: `success`, text: `Profile updated successfully.` }) } catch (e) { let t = e?.response?.data?.message; v({ type: `error`, text: t ?? `Failed to save changes. Please try again.` }) } finally { g(!1) } } return (0, l.jsx)(o, {
...
} var d = () => (0, l.jsxs)(l.Fragment, { children: [(0, l.jsx)(s, { title: `Setting | 2Deal - Online Saree & Ethnic Wear Store`, description: `2Deal - Online Saree & Ethnic Wear Store` }), (0, l.jsx)(a, {}), (0, l.jsx)(u, {})] }); export { d as default };