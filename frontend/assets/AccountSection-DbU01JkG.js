import{y as i,o as l,n as p,j as c,L as r}from"./index-D4SA88lz.js";function m(o){return null}const d=[{href:"/account-page",label:"Dashboard",icon:"icon-HouseLine"},{href:"/account-orders",label:"My Orders",icon:"icon-Package"},{href:"/account-addresses",label:"My Addresses",icon:"icon-storefront"},{href:"/account-setting",label:"Settings",icon:"icon-GearSix"},{href:"/account-wallet",label:"My Wallet",icon:"icon-Wallet"}];function u(){const{pathname:o}=i(),e=l(),{logout:s}=p();function n(){s(),e("/")}return c.jsxs("div",{className:"sidebar-account-custom",children:[c.jsx("style",{children:`
