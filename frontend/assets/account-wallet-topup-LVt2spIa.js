import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{t}from"./react-CZI7_Jkm.js";import{h as n}from"./api-BFkhFdfc.js";import{C as r,E as i,c as a}from"./index-Bz0JOd7n.js";import{n as o,t as s}from"./AccountSection-D2FTARNg.js";import{t as c}from"./PageMeta-CyS8ELM3.js";var l=e(t(),1),u=a();function d(){let e=i(),[t,a]=(0,l.useState)(``),[o,c]=(0,l.useState)(``),[d,f]=(0,l.useState)(!1),[p,m]=(0,l.useState)(null),[h,g]=(0,l.useState)(null),_=[50,100,200,500];function v(e){a(e.toString()),m(null)}async function y(r){r.preventDefault(),m(null),g(null);let i=parseFloat(t);if(isNaN(i)||i<=0){m(`Please enter a valid amount greater than 0.`);return}f(!0);try{let t=await n.topupWallet({amount:i});t.data?.success?(g(t.data.message||`Funds added successfully!`),setTimeout(()=>{e(`/account-wallet`)},1500)):m(t.data?.message||`Failed to add funds. Please try again.`)}catch(e){let t=e?.response?.data?.message;m(t??`Failed to perform deposit. Please verify connection and try again.`)}finally{f(!1)}}return(0,u.jsx)(s,{title:`Add Funds to Wallet`,children:(0,u.jsxs)(`div`,{className:`topup-container-custom`,children:[(0,u.jsx)(`style`,{children:`
