import{y as i,o as l,n as d,j as c,L as r}from"./index-DfJ1NbJI.js";function m(a){return null}const p=[{href:"/account-page",label:"Dashboard",icon:"icon-HouseLine"},{href:"/account-orders",label:"My Orders",icon:"icon-Package"},{href:"/account-addresses",label:"My Addresses",icon:"icon-storefront"},{href:"/account-setting",label:"Settings",icon:"icon-GearSix"},{href:"/account-wallet",label:"My Wallet",icon:"icon-Wallet"},{href:"/account-royalty",label:"Royalty Points",icon:"icon-star"}];function u(){const{pathname:a}=i(),s=l(),{logout:e}=d();function n(){e(),s("/")}return c.jsxs("div",{className:"sidebar-account-custom",children:[c.jsx("style",{children:`
