import{r as s,o as x,j as e}from"./index-DDJqAGfq.js";import{A as w,a as N}from"./AccountSection-BrKnrk5_.js";import{f,a as v}from"./formatPrice-DUdkiy9u.js";import{P}from"./PageMeta-DAQcfpqo.js";function R(){const[a,h]=s.useState(null),[l,y]=s.useState([]),[m,b]=s.useState(0),[g,u]=s.useState(!0),[j,d]=s.useState(!0),[o,c]=s.useState(1),r=10;s.useEffect(()=>{x.getRoyalty().then(t=>{t.data?.success&&h(t.data.data)}).catch(console.error).finally(()=>u(!1))},[]),s.useEffect(()=>{d(!0);const t=(o-1)*r;x.getRoyaltyTransactions({limit:r,offset:t}).then(p=>{if(p.data?.success){const i=p.data.data;y(i.rows??i.transactions??[]),b(i.total??0)}}).catch(console.error).finally(()=>d(!1))},[o]);const n=Math.ceil(m/r);return e.jsx(w,{title:"Royalty Points",children:e.jsxs("div",{className:"royalty-page",children:[e.jsx("style",{children:`
        ...
        `}),g?e.jsx("div",{className:"royalty-card",children:"Loading…"}):a?e.jsxs("div",{className:"royalty-card",children:[e.jsx("h4",{children:"Available Royalty Points"}),e.jsxs("div",{className:"royalty-points",children:[a.points," pts"]}),e.jsxs("div",{className:"royalty-meta",children:["≈ ",f(a.balance_rm)," · ",a.conversion_label??"500 pts = RM 100"]}),a.hint&&e.jsx("div",{className:"royalty-hint",children:a.hint}),e.jsxs("p",{className:"mt-3 mb-0 small text-muted",children:["Royalty points are separate from your wallet. Earn after paid / COD orders. Pay with points when you have Rs ",Number(a.min_redeem_rm??100),"+ (",a.min_redeem_points,"+ pts); any remaining bill uses COD or online payment."]})]}):e.jsx("div",{className:"royalty-card",children:"Could not load royalty points."}),e.jsx("h5",{className:"mb-3",children:"Royalty history"}),e.jsx("div",{className:"tx-table-wrapper",children:j?e.jsx("div",{className:"p-4 text-muted",children:"Loading…"}):l.length===0?e.jsx("div",{className:"p-4 text-muted text-center",children:"No royalty activity yet."}):e.jsxs("table",{className:"tx-table",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Date"}),e.jsx("th",{children:"Type"}),e.jsx("th",{children:"Points"}),e.jsx("th",{children:"Value"}),e.jsx("th",{children:"Balance"}),e.jsx("th",{children:"Details"})]})}),e.jsx("tbody",{children:l.map(t=>e.jsxs("tr",{children:[e.jsx("td",{children:v(t.created_at)}),e.jsx("td",{children:e.jsx("span",{className:t.type==="earn"?"badge-earn":"badge-redeem",children:t.type==="earn"?"Earn":"Redeem"})}),e.jsxs("td",{children:[t.type==="earn"?"+":"−",t.points," pts"]}),e.jsx("td",{children:f(t.amount_rm)}),e.jsxs("td",{children:[t.balance_after_points," pts"]}),e.jsx("td",{className:"small text-muted",children:t.description||t.reference})]},t.id))})]})}),n>1&&e.jsxs("div",{className:"tx-pagination",children:[e.jsxs("span",{className:"small text-muted",children:["Page ",o," of ",n]}),e.jsxs("div",{style:{display:"flex",gap:8},children:[e.jsx("button",{className:"tx-page-btn",disabled:o<=1,onClick:()=>c(t=>t-1),children:"Prev"}),e.jsx("button",{className:"tx-page-btn",disabled:o>=n,onClick:()=>c(t=>t+1),children:"Next"})]})]})]})})}const E=()=>e.jsxs(e.Fragment,{children:[e.jsx(P,{title:"Royalty Points | 2DEAL",description:"View and track your royalty points separately from wallet balance."}),e.jsx(N,{}),e.jsx(R,{})]});export{E as default};
